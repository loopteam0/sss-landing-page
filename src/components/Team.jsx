            ...
            md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                    ...
                    lg:max-w-2xl md:mb-12 text-center">
                        ...
                        {/* <p className="text-base text-gray-700 md:text-lg">
                            We are guided, advised and mentored by seasoned industry experts who believe in our vision.
                        </p> */}
                    </div>
                    <div className="grid gap-14  mx-auto sm:grid-cols-2
    ...
    return (
        <div className='flex flex-col items-center' >
            ...
            <div className="flex flex-col items-center justify-center mt-2 space-y-2" >
                ...
                <p className="mb-4 text-sm text-gray-800">Product Manager</p>
                {/* <p className="text-sm w-5/6 md:w-full text-center tracking-wide text-gray-800">
